...
echo -e "\n[5/7] Testing black swan event (99% crash)..."
...
echo -e "\n[6/7] Testing MOET depeg scenario..."
flow test --cover cadence/tests/moet_depeg_test.cdc

echo -e "\n[7/7] Testing concurrent rebalancing..."
...
echo "  python3 run_price_test.py --prices <prices> --descriptions <descriptions> --name <name>"
echo "" 