...
access(all)
fun test_RebalanceTideScenario3_Path_C() {
	...
	logStep("Scenario3_Path_C", 0, actualDebt, 615.38461539, actualYieldUnits, 615.38461539, actualCollateral, 1000.00000000)
	...
	// Step 1: after FLOW
	setMockOraclePrice(signer: tidalYieldAccount, forTokenIdentifier: flowTokenIdentifier, price: 2.00000000)
	setMockOraclePrice(signer: tidalYieldAccount, forTokenIdentifier: yieldTokenIdentifier, price: 1.00000000)
	rebalanceTide(signer: tidalYieldAccount, id: tideIDs![0], force: true, beFailed: false)
	...
	actualCollateral = flowCollateralAmount * 2.00000000
	logStep("Scenario3_Path_C", 1, actualDebt, 1230.76923077, actualYieldUnits, 1230.76923077, actualCollateral, 2000.00000000)
	Test.assert(equalAmounts(a: actualDebt, b: 1230.76923077, tolerance: 0.0000001), message: "Debt mismatch at step 1")
	Test.assert(equalAmounts(a: actualYieldUnits, b: 1230.76923077, tolerance: 0.0000001), message: "Yield mismatch at step 1")
	Test.assert(equalAmounts(a: actualCollateral, b: 2000.00000000, tolerance: 0.0000001), message: "Collateral mismatch at step 1")

	// Step 2: after YIELD
	setMockOraclePrice(signer: tidalYieldAccount, forTokenIdentifier: flowTokenIdentifier, price: 2.00000000)
	setMockOraclePrice(signer: tidalYieldAccount, forTokenIdentifier: yieldTokenIdentifier, price: 2.00000000)
	rebalanceTide(signer: tidalYieldAccount, id: tideIDs![0], force: true, beFailed: false)
	rebalancePosition(signer: protocolAccount, pid: pid, force: true, beFailed: false)
	actualDebt = getMOETDebtFromPosition(pid: pid)
	actualYieldUnits = getAutoBalancerBalance(id: tideIDs![0]) ?? 0.0
	flowCollateralAmount = getFlowCollateralFromPosition(pid: pid)
	actualCollateral = flowCollateralAmount * 2.00000000
	logStep("Scenario3_Path_C", 2, actualDebt, 1988.16568047, actualYieldUnits, 994.08284024, actualCollateral, 3230.76923077)
	Test.assert(equalAmounts(a: actualDebt, b: 1988.16568047, tolerance: 0.0000001), message: "Debt mismatch at step 2")
	Test.assert(equalAmounts(a: actualYieldUnits, b: 994.08284024, tolerance: 0.0000001), message: "Yield mismatch at step 2")
	Test.assert(equalAmounts(a: actualCollateral, b: 3230.76923077, tolerance: 0.0000001), message: "Collateral mismatch at step 2")
