...
fun test_RebalanceTideScenario3_Path_B() {
	...
	logStep("Scenario3_Path_B", 0, actualDebt, 615.38461539, actualYieldUnits, 615.38461539, actualCollateral, 1000.00000000)
	...
	actualCollateral = flowCollateralAmount * 1.50000000
	logStep("Scenario3_Path_B", 1, actualDebt, 923.07692308, actualYieldUnits, 923.07692308, actualCollateral, 1500.00000000)
	Test.assert(equalAmounts(a: actualDebt, b: 923.07692308, tolerance: 0.0000001), message: "Debt mismatch at step 1")
	Test.assert(equalAmounts(a: actualYieldUnits, b: 923.07692308, tolerance: 0.0000001), message: "Yield mismatch at step 1")
	Test.assert(equalAmounts(a: actualCollateral, b: 1500.00000000, tolerance: 0.0000001), message: "Collateral mismatch at step 1")
	...
	flowCollateralAmount = getFlowCollateralFromPosition(pid: pid)
	actualCollateral = flowCollateralAmount * 1.50000000
	logStep("Scenario3_Path_B", 2, actualDebt, 1093.49112426, actualYieldUnits, 841.14701866, actualCollateral, 1776.92307692)
	Test.assert(equalAmounts(a: actualDebt, b: 1093.49112426, tolerance: 0.0000001), message: "Debt mismatch at step 2")
	Test.assert(equalAmounts(a: actualYieldUnits, b: 841.14701866, tolerance: 0.0000001), message: "Yield mismatch at step 2")
	Test.assert(equalAmounts(a: actualCollateral, b: 1776.92307692, tolerance: 0.0000001), message: "Collateral mismatch at step 2")
