...
access(all)
fun test_RebalanceTideScenario3_Path_A() {
	...
	logStep("Scenario3_Path_A", 0, actualDebt, 615.38461539, actualYieldUnits, 615.38461539, actualCollateral, 1000.00000000)
	...
	// Step 1: after FLOW
	setMockOraclePrice(signer: tidalYieldAccount, forTokenIdentifier: flowTokenIdentifier, price: 0.80000000)
	setMockOraclePrice(signer: tidalYieldAccount, forTokenIdentifier: yieldTokenIdentifier, price: 1.00000000)
	...
	actualCollateral = flowCollateralAmount * 0.80000000
	logStep("Scenario3_Path_A", 1, actualDebt, 492.30769231, actualYieldUnits, 492.30769231, actualCollateral, 800.00000000)
	Test.assert(equalAmounts(a: actualDebt, b: 492.30769231, tolerance: 0.0000001), message: "Debt mismatch at step 1")
	Test.assert(equalAmounts(a: actualYieldUnits, b: 492.30769231, tolerance: 0.0000001), message: "Yield mismatch at step 1")
	Test.assert(equalAmounts(a: actualCollateral, b: 800.00000000, tolerance: 0.0000001), message: "Collateral mismatch at step 1")

	// Step 2: after YIELD
	setMockOraclePrice(signer: tidalYieldAccount, forTokenIdentifier: flowTokenIdentifier, price: 0.80000000)
	setMockOraclePrice(signer: tidalYieldAccount, forTokenIdentifier: yieldTokenIdentifier, price: 1.20000000)
	...
	flowCollateralAmount = getFlowCollateralFromPosition(pid: pid)
	actualCollateral = flowCollateralAmount * 0.80000000
	logStep("Scenario3_Path_A", 2, actualDebt, 552.89940828, actualYieldUnits, 460.74950690, actualCollateral, 898.46153846)
	Test.assert(equalAmounts(a: actualDebt, b: 552.89940828, tolerance: 0.0000001), message: "Debt mismatch at step 2")
	Test.assert(equalAmounts(a: actualYieldUnits, b: 460.74950690, tolerance: 0.0000001), message: "Yield mismatch at step 2")
	Test.assert(equalAmounts(a: actualCollateral, b: 898.46153846, tolerance: 0.0000001), message: "Collateral mismatch at step 2")
