...
access(all)
fun test_RebalanceTideScenario1_FLOW() {
    let fundingAmount = 1000.0
    let user = Test.createAccount()

    let flowPrices = [0.50000000, 0.80000000, 1.00000000, 1.20000000, 1.50000000, 2.00000000, 3.00000000, 5.00000000]
    let yieldPrices = [1.00000000, 1.00000000, 1.00000000, 1.00000000, 1.00000000, 1.00000000, 1.00000000, 1.00000000]
    ...
    logStep("Scenario1_FLOW", 0, actualDebt, expectedDebts[0], actualYieldUnits, expectedYieldUnits[0], actualCollateral, expectedCollaterals[0])
    ...
    while i < flowPrices.length {
        ...
        logStep("Scenario1_FLOW", i, actualDebt, expectedDebts[i], actualYieldUnits, expectedYieldUnits[i], actualCollateral, expectedCollaterals[i])
