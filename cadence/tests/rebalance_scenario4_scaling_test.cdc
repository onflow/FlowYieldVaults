...
access(all)
fun test_RebalanceTideScenario4_Scaling() {
	// Test.reset(to: snapshot)

	let initialFlows = [100.00000000, 500.00000000, 1000.00000000, 5000.00000000, 10000.00000000]
	let expectedDebts = [61.53846154, 307.69230769, 615.38461538, 3076.92307692, 6153.84615385]
	let expectedYieldUnits = [61.53846154, 307.69230769, 615.38461538, 3076.92307692, 6153.84615385]
	let expectedCollaterals = [100.00000000, 500.00000000, 1000.00000000, 5000.00000000, 10000.00000000]
	...
	log("\n✅ Scenario4_Scaling test completed")
}
