...
fun test_RebalanceTideScenario3_Path_D() {
    ...
    let expectedFlowCollateralValues = [1000.00000000, 500.00000000, 653.84615385]
    let expectedDebtValues = [615.38461538, 307.69230769, 402.36686391]
    
    // Price changes
    let flowPriceDecrease = 0.50000000
    let yieldPriceIncrease = 1.50000000
