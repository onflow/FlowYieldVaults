...
access(all) fun deployContracts() {
    ...
    err = Test.deployContract(
        ...
        path: "../../lib/FlowALP/cadence/contracts/mocks/MockFlowALPConsumer.cdc",
        arguments: []
    )
    Test.expect(err, Test.beNil())
...
fun getLastPositionOpenedEvent(_ evts: [AnyStruct]): AnyStruct { // can't return event types directly, they must be cast by caller
    Test.assert(evts.length > 0, message: "Expected at least 1 FlowALP.Opened event but found none")
    return evts[evts.length - 1] as! FlowALP.Opened
}
...
fun getLastPositionDepositedEvent(_ evts: [AnyStruct]): AnyStruct { // can't return event types directly, they must be cast by caller
    Test.assert(evts.length > 0, message: "Expected at least 1 FlowALP.Deposited event but found none")
    return evts[evts.length - 1] as! FlowALP.Deposited
}
...
access(all) fun findBalance(
    details: FlowALP.PositionDetails,
    vaultType: Type
): UFix64? {
...
access(all)
fun updateBridgePauseStatus(_ signer: Test.TestAccount, pause: Bool) {
    let pauseResult = _executeTransaction(
        "../../lib/flow-evm-bridge/cadence/transactions/bridge/admin/pause/update_bridge_pause_status.cdc",
        [pause],
        signer
    )
...
access(all)
fun setupBridge(bridgeAccount: Test.TestAccount, serviceAccount: Test.TestAccount, unpause: Bool): BridgeSetupResult {
    ...
    err = Test.deployContract(
        name: "ArrayUtils",
        path: "../../imports/1e4aa0b87d10b141/ArrayUtils.cdc",
        arguments: []
    )
    Test.expect(err, Test.beNil())
    err = Test.deployContract(
        name: "StringUtils",
        path: "../../imports/1e4aa0b87d10b141/StringUtils.cdc",
        arguments: []
    )
    Test.expect(err, Test.beNil())
    err = Test.deployContract(
        name: "ScopedFTProviders",
        path: "../../imports/1e4aa0b87d10b141/ScopedFTProviders.cdc",
        arguments: []
    )
    Test.expect(err, Test.beNil())
    err = Test.deployContract(
    ...
    createCOA(bridgeAccount, fundingAmount: 1_000.0)
    ...
    Test.assert(evts.length >= 6, message: "Expected at least 6 EVM events")
    ...
    err = Test.deployContract(
        ...
        path: "../../imports/1e4aa0b87d10b141/FlowEVMBridgeResolver.cdc",
        arguments: []
    )
    Test.expect(err, Test.beNil())
    ...
    err = Test.deployContract(
        ...
        path: "../../imports/1e4aa0b87d10b141/FlowEVMBridgeHandlers.cdc",
        arguments: []
    )
    Test.expect(err, Test.beNil())
    ...
    let setRegistryResult = _executeTransaction(
        "../../lib/flow-evm-bridge/cadence/transactions/bridge/admin/evm/set_deployment_registry.cdc",
        [registryAddressHex],
        bridgeAccount
    )
    Test.expect(setRegistryResult, Test.beSucceeded())
    // Set factory as delegatedDeployer in erc20Deployer
    var setDelegatedDeployerResult = _executeTransaction(
        "../../lib/flow-evm-bridge/cadence/transactions/bridge/admin/evm/set_delegated_deployer.cdc",
    ...
    setDelegatedDeployerResult = _executeTransaction(
        "../../lib/flow-evm-bridge/cadence/transactions/bridge/admin/evm/set_delegated_deployer.cdc",
    ...
    var addDeployerResult = _executeTransaction(
        "../../lib/flow-evm-bridge/cadence/transactions/bridge/admin/evm/add_deployer.cdc",
    ...
    addDeployerResult = _executeTransaction(
        "../../lib/flow-evm-bridge/cadence/transactions/bridge/admin/evm/add_deployer.cdc",
    ...
    err = Test.deployContract(
        ...
        path: "../../imports/1e4aa0b87d10b141/FlowEVMBridgeNFTEscrow.cdc",
        arguments: []
    )
    Test.expect(err, Test.beNil())
    err = Test.deployContract(
        name: "FlowEVMBridgeTokenEscrow",
        path: "../../imports/1e4aa0b87d10b141/FlowEVMBridgeTokenEscrow.cdc",
        arguments: []
    )
    Test.expect(err, Test.beNil())
    err = Test.deployContract(
        name: "FlowEVMBridgeTemplates",
        path: "../../imports/1e4aa0b87d10b141/FlowEVMBridgeTemplates.cdc",
        arguments: []
    )
    Test.expect(err, Test.beNil())
    ...
    err = Test.deployContract(
        name: "FlowEVMBridge",
        path: "../../imports/1e4aa0b87d10b141/FlowEVMBridge.cdc",
        arguments: []
    )
    Test.expect(err, Test.beNil())
    err = Test.deployContract(
        name: "FlowEVMBridgeAccessor",
        path: "../../imports/1e4aa0b87d10b141/FlowEVMBridgeAccessor.cdc",
        arguments: [serviceAccount.address]
    )
    Test.expect(err, Test.beNil())

    let claimAccessorResult = _executeTransaction(
        "../../lib/flow-evm-bridge/cadence/transactions/bridge/admin/evm-integration/claim_accessor_capability_and_save_router.cdc",
    ...
    if unpause {
        // Unpause the bridge
        updateBridgePauseStatus(bridgeAccount, pause: false)
    }

    return BridgeSetupResult(
        registryAddressHex: registryAddressHex,
        erc20DeployerAddressHex: erc20DeployerAddressHex,
        erc721DeployerAddressHex: erc721DeployerAddressHex
    )
}
