...
fun test_RebalanceTideScenario3_Path_C() {
    ...
    let expectedFlowCollateralValues = [1000.00000000, 2000.00000000, 3230.76923077]
    let expectedDebtValues = [615.38461538, 1230.76923077, 1988.16568047]
    
    // Price changes
    let flowPriceDecrease = 2.00000000
    let yieldPriceIncrease = 2.00000000
