...
fun test_RebalanceYieldVaultScenario3B() {
    ...
    setPoolToPrice(
        ...
        tokenBAddress: wflowAddress,
        fee: 3000,
        priceTokenBPerTokenA: fee3000Premium / flowPriceIncrease,
        tokenABalanceSlot: pyusd0BalanceSlot,
        tokenBBalanceSlot: wflowBalanceSlot,
        signer: coaOwnerAccount
    )
	...
	Test.assert(
		equalAmounts(a:yieldTokensAfterFlowPriceIncrease, b:expectedYieldTokenValues[1], tolerance: expectedYieldTokenValues[1] * forkedPrecisionTolerance),
	...
	Test.assert(
		equalAmounts(a:flowCollateralValueAfterFlowIncrease, b:expectedFlowCollateralValues[1], tolerance: expectedFlowCollateralValues[1] * forkedPrecisionTolerance),
	...
	Test.assert(
		equalAmounts(a:debtAfterFlowIncrease, b:expectedDebtValues[1], tolerance: expectedDebtValues[1] * forkedPrecisionTolerance),
