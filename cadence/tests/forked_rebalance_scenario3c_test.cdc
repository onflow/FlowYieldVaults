...
fun test_ForkedRebalanceYieldVaultScenario3C() {
    ...
    // FLOW=$2, so 1 WFLOW = flowPriceIncrease PYUSD0
    ...
    let debtAfterFlowIncrease = getPYUSD0DebtFromPosition(pid: pid)
    ...
    // FUSDEV is now worth 2x: 1 FUSDEV = yieldPriceIncrease PYUSD0
    ...
    // 1 FUSDEV = yieldPriceIncrease PYUSD0 (FUSDEV is now worth 2x)
