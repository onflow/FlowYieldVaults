...
import "FlowToken"
import "MOET"
import "FlowYieldVaultsStrategiesV1"
import "FlowALPv1"
import "EVM"
...
fun setup() {
    ...
    addStrategyComposer(
        ...
        composerIdentifier: Type<@FlowYieldVaultsStrategiesV1_1.MorphoERC4626StrategyComposer>().identifier,
        issuerStoragePath: FlowYieldVaultsStrategiesV1_1.IssuerStoragePath,
        beFailed: false
    )
