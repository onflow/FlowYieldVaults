...
access(all) fun test_Scenario2_Yield_Instant() {
    ...
    while i < 7 {
        ...
        log("Step \(i): Expected Debt: [615.384615385, 653.25443787, 689.800140687, 725.174506877, 793.830081492, 956.667021286, 1251.026104758][i], Actual: \(actualDebt)")
        Test.assert(equalAmounts(a: actualDebt, b: [615.384615385, 653.25443787, 689.800140687, 725.174506877, 793.830081492, 956.667021286, 1251.026104758][i], tolerance: 0.00000001), message: "Debt mismatch at step \(i)")
        log("Step \(i): Expected Yield: [615.384615385, 593.86767079, 574.833450573, 557.826543751, 529.220054328, 478.333510643, 417.008701586][i], Actual: \(actualYield)")
        Test.assert(equalAmounts(a: actualYield, b: [615.384615385, 593.86767079, 574.833450573, 557.826543751, 529.220054328, 478.333510643, 417.008701586][i], tolerance: 0.00000001), message: "Yield mismatch at step \(i)")
        log("Step \(i): Expected Collateral: [1000.0, 1061.538461539, 1120.925228617, 1178.408573675, 1289.973882425, 1554.583909589, 2032.917420232][i], Actual: \(actualCollateral)")
        Test.assert(equalAmounts(a: actualCollateral, b: [1000.0, 1061.538461539, 1120.925228617, 1178.408573675, 1289.973882425, 1554.583909589, 2032.917420232][i], tolerance: 0.00000001), message: "Collateral mismatch at step \(i)")
        i = i + 1
    }
