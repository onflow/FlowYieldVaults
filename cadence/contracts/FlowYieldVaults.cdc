...
access(all) contract FlowYieldVaults {
    ...
    access(all) resource YieldVault : Burner.Burnable, FungibleToken.Receiver, ViewResolver.Resolver {
        ...
        init(strategyType: Type, withVault: @{FungibleToken.Vault}) {
            ...
            let _strategy <- FlowYieldVaults.createStrategy(
                    type: strategyType,
    ...
    access(all) resource YieldVaultManager : ViewResolver.ResolverCollection {
        ...
        access(all) fun createYieldVault(
            betaRef: auth(FlowYieldVaultsClosedBeta.Beta) &FlowYieldVaultsClosedBeta.BetaBadge,
            strategyType: Type,
        ...
        access(all) fun addYieldVault(betaRef: auth(FlowYieldVaultsClosedBeta.Beta) &FlowYieldVaultsClosedBeta.BetaBadge, _ yieldVault: @YieldVault) {
            pre {
        ...
        access(all) fun depositToYieldVault(betaRef: auth(FlowYieldVaultsClosedBeta.Beta) &FlowYieldVaultsClosedBeta.BetaBadge, _ id: UInt64, from: @{FungibleToken.Vault}) {
            pre {
        ...
        access(FungibleToken.Withdraw) fun withdrawYieldVault(betaRef: auth(FlowYieldVaultsClosedBeta.Beta) &FlowYieldVaultsClosedBeta.BetaBadge, id: UInt64): @ YieldVault {
            pre {
                self.yieldVaults[id] != nil:
                "No YieldVault with ID \(id) found"
    ...
    init() {
        var pathIdentifier = "FlowYieldVaultsYieldVaultManager_\(self.account.address)"
        ...
        pathIdentifier = "FlowYieldVaultsStrategyFactory_\(self.account.address)"
