...
///
/// IMPORTANT: This transaction can ONLY be signed by the FlowYieldVaults contract account
...
transaction(yieldVaultID: UInt64) {
    prepare(signer: auth(BorrowValue) &Account) {
        // This will only work if signer is the FlowYieldVaultsSchedulerRegistry contract account
