...
flow transactions send ./cadence/tests/transactions/mocks/add_gw_keys.cdc --signer evm-gateway

# evm-gateway
flow transactions send "./cadence/tests/transactions/flow-token/transfer_flow.cdc" 0xe03daebed8ca0615 1000.0

# flow yield vaults
echo "fund flow yield vaults"
flow transactions send "./cadence/tests/transactions/flow-token/transfer_flow.cdc" 0x045a1763c93006ca 1000.0
