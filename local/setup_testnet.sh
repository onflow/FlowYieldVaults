...
flow transactions send ./cadence/transactions/flow-alp/pool-factory/create_and_store_pool.cdc 'A.d27920b6384e2a78.MOET.Vault' --network testnet --signer testnet-admin
...
flow transactions send ./lib/FlowALP/DeFiActions/cadence/transactions/fungible-tokens/setup_generic_vault.cdc 'A.dfc20aee650fcbdf.EVMVMBridgedToken_4154d5b0e2931a0a1e5b733f19161aa7d2fc4b95.Vault' --network testnet --signer testnet-admin
...
flow transactions send ./cadence/transactions/flow-vaults/admin/add_strategy_composer.cdc \
    'A.d27920b6384e2a78.FlowVaultsStrategies.TracerStrategy' \
    'A.d27920b6384e2a78.FlowVaultsStrategies.TracerStrategyComposer' \
    /storage/FlowVaultsStrategyComposerIssuer_0xd27920b6384e2a78 \
    --network testnet \
    --signer testnet-admin
