...
# 4. create swap pair
#
flow transactions send ./lib/FlowALP/DeFiActions/cadence/transactions/increment-fi/create_swap_pair.cdc $MOET_IDENTIFIER $YIELD_IDENTIFIER false
#
#
...
echo $YIELD_KEY
echo $DEADLINE
flow transactions send "./lib/FlowALP/DeFiActions/cadence/transactions/increment-fi/add_liquidity.cdc" \
	"$MOET_KEY" \
	"$YIELD_KEY" \
	100.0 \
	100.0 \
